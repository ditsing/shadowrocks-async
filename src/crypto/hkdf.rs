...
mod test {
    ...
    fn test_derive_subkey_from_zero_openssl() {
        ...
        assert_eq!(
            subkey,
            &[
                0x84, 0xF6, 0x36, 0xC6, 0x88, 0x73, 0xCF, 0xEB, 0x5B, 0xCF, 0xC1, 0x56, 0x94, 0x3F,
                0x49, 0xE4, 0xEF, 0x16, 0x68, 0xA9, 0xEE, 0x68, 0x37, 0xD7, 0x5D, 0xEA, 0x19, 0x06,
                0x20, 0x0E, 0x75, 0x0D
            ]
        );
    }
    ...
    fn test_derive_subkey_from_salt_openssl() {
        ...
        let hkdf = Hkdf::extract(
            Some(&[
                0xA9, 0xCA, 0xFD, 0x4F, 0x5F, 0xFD, 0x7A, 0x46, 0x7F, 0xFE, 0x26, 0xA1, 0xE8, 0x0A,
                0xC4, 0x4D, 0xB0, 0x1F, 0x3C, 0x58, 0xCB, 0x4D, 0x17, 0xE0, 0x3E, 0xC5, 0x2A, 0x05,
                0x6D, 0x4B, 0xB9, 0x54,
            ]),
            &[
                0x4D, 0xC8, 0xA1, 0xA7, 0xBC, 0x06, 0x74, 0x4D, 0x9C, 0x6B, 0x4F, 0xB3, 0x27, 0xFF,
                0x52, 0x69, 0x3C, 0x44, 0xF1, 0xBD, 0x94, 0xD2, 0x7D, 0xD4, 0xD6, 0xE1, 0x90, 0xAF,
                0x65, 0x71, 0x99, 0x7D,
            ],
            sha256,
        );
        ...
        assert_eq!(
            subkey,
            &[
                0xD4, 0xE4, 0x88, 0x52, 0xD8, 0x2B, 0x88, 0x6E, 0x2F, 0x8F, 0x28, 0x68, 0x83, 0x56,
                0x68, 0x69, 0x0B, 0xFE, 0xB7, 0x55, 0xEE, 0xBD, 0x21, 0xCF, 0x99, 0xBC, 0xEA, 0x88,
                0xCC, 0xCF, 0x24, 0x40
            ],
        );
    }
